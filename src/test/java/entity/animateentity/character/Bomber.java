...
public class Bomber extends Character {
    ...
    private void handleEnemyCollision() {
        map.getEnemies().forEach(enemy -> {
            if (this.isCollider(enemy) && immortal == 0) {
                ...
                // ==========================================================
                // TC5.2b: Phát hiện va chạm sát thương từ quái vật, kích hoạt tiến trình xử lý Game Over
                // ==========================================================
                destroy();
            }
        });
    ...
    private void handleItemCollision() {
        map.getItems().forEach(item -> {
            if (this.isCollider(item)) {
                ...
                // ==========================================================
                // TC5.1d: Ghi nhận sự kiện thu thập vật phẩm làm thay đổi trạng thái/điểm số phiên chơi
                // ==========================================================
                item.remove();
    ...
    public void delete() {
        // ==========================================================
        // TC5.2c: Cập nhật thông số giảm số lượng mạng sống (life) của người chơi trong phiên
        // ==========================================================
        this.life--;
        timeRevival = 7;
        immortal = 100;
