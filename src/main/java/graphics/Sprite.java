...
public class Sprite {
    ...
    public static Sprite pontan_score = new Sprite(DEFAULT_SIZE, 15, 10, SpriteSheet.tiles, 16, 16);
        ...
        private void drawAngryFaceOverlay() {
                ...
                // Lông mày cau lại bên trái
                setPixelSafe(4, 5, dark);
                setPixelSafe(5, 6, dark);
                setPixelSafe(6, 6, dark);

                // Lông mày cau lại bên phải
                setPixelSafe(11, 5, dark);
                setPixelSafe(10, 6, dark);
                setPixelSafe(9, 6, dark);

                // Mắt đỏ
                setPixelSafe(5, 7, redEye);
                setPixelSafe(10, 7, redEye);

                // Miệng giận, nét ngang tối
                setPixelSafe(6, 11, dark);
                setPixelSafe(7, 11, dark);
                setPixelSafe(8, 11, dark);
                setPixelSafe(9, 11, dark);
        }
        ...
        private void setPixelSafe(int x, int y, int color) {
                ...
                if (_pixels[index] == TRANSPARENT_COLOR)
                        return;
